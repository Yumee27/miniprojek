                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <span class="hidden-xs">Yume</span>
                            </a>
                            <ul class="dropdown-menu">
                                <!-- User image -->
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="active treeview menu-open">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li><a href="laporan.html"><i class="fa fa-book"></i> Laporan</a></li>
                            <li><a href="ganti password.php"><i class="fa fa-key"></i> Ganti password</a></li>
                            <li><a href="logut.php"><i class="fa fa-sign-out"></i>Logout</a></li>
